                            ...
                            <div class="col-md-4">
                                <div class="form-group f-g-o">
                                    ...
                                    <select class="form-control" id="myselect" class="event" name="language">
                                        ...
                                        @if($type ==2)
                                        <option value="{{$data->id}}"{{$data->id == $session->language ? 'selected':''}}>{{$data->language}}</option>
                                        @else
...
<div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            @else
                            <label class="radio-inline ml-4"> <input type="radio" name="optradio" value="video" id="video" {{$session->media_type == "video" ? "checked" : ""}} />video </label>
                            @endif
                            @if($type ==1)
