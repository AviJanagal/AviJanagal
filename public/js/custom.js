...
// splash logo
  ...
  // app icon
   var loadFile3 = function(event) {
    var appiconimage = document.getElementById('appiconimage');
    appiconimage.src = URL.createObjectURL(event.target.files[0]);
    appiconimage.onload = function() {
      URL.revokeObjectURL(appiconimage.src)
    }
  };
